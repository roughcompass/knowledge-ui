  ...
  return [
    {
      ...
      source_locator: redacted ? null : 'registry://directives/change-control',
      source_revision_locator: redacted ? null : 'registry://directives/change-control@rev-7',
    ...
    },
    {
      ...
      source_locator: 'registry://guidance/deployment-checklist',
      source_revision_locator: 'registry://guidance/deployment-checklist@rev-3',
...
function receipt(receiptId: string, redacted: boolean) {
  return {
    ...
    registry_build_revision: 'registry-2026.08.06',
